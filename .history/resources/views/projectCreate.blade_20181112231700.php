...
@section('content')
    <form method="POST" action="/project">
        ...
        <input type="text" class="form-control  {{ $errors->has('title') ? 'danger' : '' }}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Project Name"  name="title" value="{{ old('title') }}" required>
